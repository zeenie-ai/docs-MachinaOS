...
| [Python Executor](/nodes/code) | Action (also AI tool) | Run Python code |
...
The Python Executor moved to its own page alongside the other code nodes — see [Code Executors](/nodes/code). It pairs naturally with schedulers: a Cron Scheduler firing into a Python Executor is the classic zero-credential automation.
