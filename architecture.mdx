---
title: Architecture
description: Deep dive into MachinaOs system architecture, execution engine, AI agents, and cache/security layers (plugin-first, WebSocket-first, Temporal execution)
---
